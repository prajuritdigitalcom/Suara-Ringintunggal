...
import { Program, Vote, Captcha } from '../types';
...
import { 
  ...
  RefreshCw, Send, ShieldCheck, AlertCircle
} from 'lucide-react';
...
export default function ProgramDetail({ program, votes, onBack, onVoteSuccess, onShareClick }: ProgramDetailProps) {
  ...
  // Fetch captcha on component mount or program change
  useEffect(() => {
    fetchCaptcha();
    // Reset form states
    setVoterName('');
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6 sm:py-10 space-y-8 pb-24">
      ...
      {/* FORMULIR DUKUNGAN WARGA - INLINE / TANPA POP UP */}
      <div ref={formRef} id="form-dukungan" className="bg-white rounded-3xl border border-slate-100 shadow-md overflow-hidden animate-fadeIn">
        {/* Header */}
        <div className="px-6 py-5 bg-gradient-to-r from-emerald-50 to-white border-b border-emerald-100 flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Hanya bisa mendukung 1 kali.</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6">
          {successMessage ? (
            ...
            <form onSubmit={handleVoteSubmit} className="space-y-4">
              {/* Error Notification */}
              {errorMessage && (
                <div className="p-3 bg-red-50 border border-red-100 rounded-xl flex items-start space-x-2 text-red-800 text-xs sm:text-sm">
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 sm:py-3 text-slate-800 placeholder-slate-400 bg-slate-50 hover:bg-slate-100/50 focus:bg-white border border-slate-200 focus:border-emerald-500 rounded-xl outline-none transition-all text-xs sm:text-sm font-medium"
                />
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full px-4 py-2.5 sm:py-3 text-slate-800 bg-slate-50 hover:bg-slate-100/50 focus:bg-white border border-slate-200 focus:border-emerald-500 rounded-xl outline-none transition-all text-xs sm:text-sm font-semibold cursor-pointer"
                >
                  {['RT 01', 'RT 02', 'RT 03', 'RT 04', 'RT 05', 'RT 06', 'RT 07', 'RT 08', 'RT 09', 'RT 10'].map((rt) => (
              ...
              <div className="p-4 bg-emerald-50/50 border border-emerald-100/60 rounded-2xl space-y-3">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="px-4 py-2.5 bg-white border border-emerald-200 rounded-xl text-center font-mono font-bold text-sm sm:text-base text-emerald-950 min-w-[100px] shadow-xs select-none">
                  ...
                  <div className="flex-1">
                    <input
                      ...
                      className="w-full px-3 py-2.5 bg-white text-slate-800 placeholder-slate-400 border border-emerald-200 focus:border-emerald-500 rounded-xl outline-none text-center font-mono font-bold text-sm sm:text-base"
                    />
                  </div>
                </div>
              </div>
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="w-full py-3 px-4 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs sm:text-sm rounded-xl shadow-lg shadow-emerald-200 transition-all cursor-pointer disabled:opacity-75 flex items-center justify-center space-x-2"
              >
